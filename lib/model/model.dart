...
List<Task> tasks = [
  Task(
    currentTime: "07:00",
    remainingTime: "1 h 45 دقیقه",
    title: "ورزش",
    subtitle: "تمرین فوتبال و والیبال",
    profileImage:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHDRlp-KGr_M94k_oor4Odjn2UzbAS7n1YoA&s",
    name: "جعفر",
    id: "722-085-9210",
    location: "بلوار طبرسی",
    room: "کلاس الف 1 , طبقه 1",
  ),
  Task(
    currentTime: "09:30",
    remainingTime: "2 h",
    title: "شیمی",
    subtitle: "درس 3 تدریس شود",
    profileImage:
